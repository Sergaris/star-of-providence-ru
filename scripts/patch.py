...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "mirror_strings.csv": {
        ...
        "took & hits": "& ударов",
        "& rooms": "& комнат",
        "& secret rooms": "& тайных комнат",
        "empty": "пусто",
        "hold left to#delete a report": (
            "удерживай влево#чтобы удалить отчёт"
        ),
        "hold right to#save report": "удерживай вправо#для сохранения",
        "hold right to#overwrite report": (
            "удерживай вправо#чтобы перезаписать отчёт"
        ),
        "reflect on your past": "взгляни на своё прошлое",
        "begin": "начать",
        "recall past battles": "вспомни прошлые бои",
        "tier": "уровень",
        "default": "базовый",
        "damaged": "повреждённый",
        "original": "оригинальный",
        "trial i": "испытание i",
        "trial ii": "испытание ii",
        "trial iii": "испытание iii",
        "trial iv": "испытание iv",
        "trial v": "испытание v",
        "looking for something..?": "что-то ищешь..?",
        "loop": "цикл",
        "iron magus": "железный маг",
        "omniscient": "всеведущий",
        "gunship": "боевой корабль",
        "late knight": "покойный рыцарь",
        "abyssal": "бездонный",
